...
class SimpleImage {
    ...
    function resize($width, $height)
    {
        ...
        if ($this->image_type == IMAGETYPE_GIF || $this->image_type == IMAGETYPE_PNG || $this->image_type == IMAGETYPE_WEBP)
        {
            ...
            elseif ($this->image_type == IMAGETYPE_PNG || $this->image_type == IMAGETYPE_WEBP)
            {
