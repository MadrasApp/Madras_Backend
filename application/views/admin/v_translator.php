...
$cols['حذف'] =
    array(
			'field_name' => 'id',
			'link'    => false,
			'html'    => '<i class="fa fa-trash text-danger cu" onClick="delete_row(this,\'translator\',[ID])"></i>'
		);


$q ="SELECT c.* FROM ci_translator c $query";
?>
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title">
		نویسندگان 
		<a class="btn-sm btn-warning pull-left" onclick="new_translator();">مترجم جدید</a>
