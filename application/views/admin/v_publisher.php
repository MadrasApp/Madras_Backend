...
$cols['حذف'] =
    array(
			'field_name' => 'id',
			'link'    => false,
			'html'    => '<i class="fa fa-trash text-danger cu" onClick="delete_row(this,\'publisher\',[ID])"></i>'
		);


$q ="SELECT c.* FROM ci_publisher c $query";
?>
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title">
		انتشارات 
		<a class="btn-sm btn-warning pull-left" onclick="new_publisher();">انتشارات جدید</a>
