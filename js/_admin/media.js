...
function updateMediaSidbar(file,thumb,insert){
	...
	var data = $(file).data(),
		...
		thumb150  = BURL+data.thumb150.replace('/lexoya/var/www/html/', ''),
		thumb300  = BURL+data.thumb300.replace('/lexoya/var/www/html/', ''),
		thumb600  = BURL+data.thumb600.replace('/lexoya/var/www/html/', ''), 
